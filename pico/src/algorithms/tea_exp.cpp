...
void run_tea_experiments(void) {
    const unsigned key_bytes = CryptoPP::TEA::DEFAULT_KEYLENGTH;
    const unsigned block_bytes = CryptoPP::TEA::BLOCKSIZE;
    ...
    CryptoPP::TEA::Encryption enc;
    CryptoPP::TEA::Decryption dec;
    ...
    printf("tea_cryptopp,%u,%u,%lld,%02x,%02x,%s\n",
           key_bytes, block_bytes, static_cast<long long>(elapsed_us), key[0], out_block[0], "Crypto++ TEA encrypt");
}
