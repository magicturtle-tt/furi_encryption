...
void run_hight_experiments(void) {
    const unsigned key_bytes = CryptoPP::HIGHT::DEFAULT_KEYLENGTH;
    const unsigned block_bytes = CryptoPP::HIGHT::BLOCKSIZE;
    ...
    CryptoPP::HIGHT::Encryption enc;
    CryptoPP::HIGHT::Decryption dec;
    ...
    printf("hight_cryptopp,%u,%u,%lld,%02x,%02x,%s\n",
           key_bytes, block_bytes, static_cast<long long>(elapsed_us), key[0], out_block[0], "Crypto++ HIGHT encrypt");
}
