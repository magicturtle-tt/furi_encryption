...
void run_simon_experiments(void) {
    const unsigned key_bytes = CryptoPP::SIMON128::DEFAULT_KEYLENGTH;
    const unsigned block_bytes = CryptoPP::SIMON128::BLOCKSIZE;
    ...
    CryptoPP::SIMON128::Encryption enc;
    CryptoPP::SIMON128::Decryption dec;
    ...
    printf("simon128_cryptopp,%u,%u,%lld,%02x,%02x,%s\n",
           key_bytes, block_bytes, static_cast<long long>(elapsed_us), key[0], out_block[0], "Crypto++ SIMON128 encrypt");
}
