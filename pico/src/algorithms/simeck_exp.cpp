...
void run_simeck_experiments(void) {
    const unsigned key_bytes = CryptoPP::SIMECK64::DEFAULT_KEYLENGTH;
    const unsigned block_bytes = CryptoPP::SIMECK64::BLOCKSIZE;
    ...
    CryptoPP::SIMECK64::Encryption enc;
    CryptoPP::SIMECK64::Decryption dec;
    ...
    printf("simeck64_cryptopp,%u,%u,%lld,%02x,%02x,%s\n",
           key_bytes, block_bytes, static_cast<long long>(elapsed_us), key[0], out_block[0], "Crypto++ SIMECK64 encrypt");
}
